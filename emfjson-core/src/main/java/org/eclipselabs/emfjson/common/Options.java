...
import static org.eclipselabs.emfjson.EMFJs.OPTION_RESOLVE_PROXY;
...
public class Options {
	...
	public final boolean serializeNamespaces;
	...
	public static class Builder {
		...
		public Options build() {
			return new Options(
					...
					booleanValue(options, OPTION_SERIALIZE_REF_TYPE, true), 
					booleanValue(options, OPTION_PROXY_ATTRIBUTES, false), 
					booleanValue(options, OPTION_SERIALIZE_NAMESPACES, false), 
