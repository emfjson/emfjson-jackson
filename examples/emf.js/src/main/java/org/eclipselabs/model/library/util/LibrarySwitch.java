...
public class LibrarySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LibraryPackage.LIBRARY_SHELF: {
				LibraryShelf libraryShelf = (LibraryShelf)theEObject;
				T result = caseLibraryShelf(libraryShelf);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LibraryPackage.ITEM: {
			...
			case LibraryPackage.MULTIMEDIA_ITEM: {
				MultimediaItem multimediaItem = (MultimediaItem)theEObject;
				T result = caseMultimediaItem(multimediaItem);
				if (result == null) result = caseItem(multimediaItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LibraryPackage.DVD: {
				DVD dvd = (DVD)theEObject;
				T result = caseDVD(dvd);
				if (result == null) result = caseMultimediaItem(dvd);
				if (result == null) result = caseItem(dvd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LibraryPackage.BLUE_RAY: {
				BlueRay blueRay = (BlueRay)theEObject;
				T result = caseBlueRay(blueRay);
				if (result == null) result = caseMultimediaItem(blueRay);
				if (result == null) result = caseItem(blueRay);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LibraryPackage.CD: {
				CD cd = (CD)theEObject;
				T result = caseCD(cd);
				if (result == null) result = caseMultimediaItem(cd);
				if (result == null) result = caseItem(cd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseLibraryShelf(LibraryShelf object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Multimedia Item</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Multimedia Item</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMultimediaItem(MultimediaItem object) {
		return null;
	}
